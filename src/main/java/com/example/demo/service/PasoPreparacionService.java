...
public class PasoPreparacionService {
    ...
    public List<PasoPreparacionDTO> obtenerPasosPorReceta(Integer idReceta) {
        ...
        return pasoRepository.findByIdRecetaOrderByOrdenAsc(idReceta)
                .stream()
                .map(this::convertirADTO)
                .collect(Collectors.toList());
    }
    ...
    public List<PasoPreparacionDTO> buscarPorTexto(Integer idReceta, String texto) {
        return pasoRepository.buscarPorTextoEnDescripcion(idReceta, texto)
                .stream()
                .map(this::convertirADTO)
                .collect(Collectors.toList());
    }
